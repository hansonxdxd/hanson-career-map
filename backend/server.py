...
DEFAULT_CONTENT = {
    ...
    "careerEvolution": {
        ...
        "subtitle": "職涯進化地圖",
        "stages": [
            {"id": 1, "slug": "origin", "visible": True, "period": "1999–2015", "title": "啟蒙與破局期", "titleEn": "Origin of Systems Thinking", "summary": "從遊戲規則、發明展與知識整理中,形成對「系統」的直覺。", "relatedProjectIds": [], "manualTags": ["Systems Thinking", "MVP", "Knowledge Mapping"], "removedAutoTags": []},
            {"id": 2, "slug": "resourceful", "visible": True, "period": "2016–2020", "title": "資源整合與跨界統籌", "titleEn": "Resourceful Creation & Cross-domain Execution", "summary": "在低預算、高限制的影像與舞台專案中,學會用有限資源創造高完成度成果。", "relatedProjectIds": ["cross-domain-visual"], "manualTags": [], "removedAutoTags": []},
            {"id": 3, "slug": "workflow", "visible": True, "period": "2020–2023", "title": "流程降維與自動化覺醒", "titleEn": "Workflow Design & Automation Mindset", "summary": "在業務、內容與自媒體實作中,開始把重複工作拆成模板、流程與產線。", "relatedProjectIds": ["ai-content-pipeline"], "manualTags": ["SOP", "Content Pipeline"], "removedAutoTags": []},
            {"id": 4, "slug": "compression", "visible": True, "period": "2024–2025", "title": "商業系統觀察與資訊降維", "titleEn": "Business Systems & Information Compression", "summary": "在高密度內容、影像與商業專案中,鍛鍊複雜資訊拆解與視覺化轉譯能力。", "relatedProjectIds": ["teaching-condense"], "manualTags": ["Business Translation"], "removedAutoTags": []},
            {"id": 5, "slug": "enterprise-ai", "visible": True, "period": "2025–Now", "title": "企業 AI 與醫療數位轉型", "titleEn": "Enterprise AI & Medical Workflow Transformation", "summary": "將過去的系統思維正式落地到企業流程、醫療器材、AI 工具與知識庫建構。", "relatedProjectIds": ["medical-literature", "enterprise-workflow"], "manualTags": ["n8n", "Business Systems"], "removedAutoTags": []},
        ],
    },
    "projects": {
        "visible": True,
